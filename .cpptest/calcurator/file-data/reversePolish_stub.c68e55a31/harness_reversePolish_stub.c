# 1 "C:\\Users\\fujisawa\\AppData\\Local\\Temp\\ParaSoft.16292.24236\\ParaSoft.16292.10061.c"
...
struct __CPTR_Initializer_1249781333_16292_3990742751 {
    __CPTR_Initializer_1249781333_16292_3990742751()
    {
...
static struct __CPTR_Initializer_1249781333_16292_3990742751 __CPTR_initializer_1249781333_16292_3990742751;
#endif

#define CPPTEST_ENTER_MAIN_ROUTINE() __CPTR_Initializer_1249781333_16292_3990742751 __CPTR_main_initializer
...
# 36 "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\stubs\\reversePolish_stub.c"
int reversePolish(char * ptr, char  outstr[256]); 
#if defined(CPPTEST_USER_STUB_reversePolish)
# 37
int CppTest_Stub_reversePolish_reversePolish(char *ptr, char outstr[256]) 
{ 

int __return = 0; 
int __callOrig = 0; 

(((((tgr_run("reversePolish", c_tgr_run_before)->WithRefArg)("ptr", &ptr, tgr_ptr_type(tgr_char_type()))->WithRefArg)("outstr", outstr, tgr_ptr_type(tgr_char_type()))->WithRefArg)("__return", &__return, tgr_int_type())->WithRefArg)("__callOrig", &__callOrig, tgr_int_type())->End)(); 
if (__callOrig) { 
int __return = reversePolish(ptr, outstr); 
((((tgr_run("reversePolish", c_tgr_run_after)->WithRefArg)("ptr", &ptr, tgr_ptr_type(tgr_char_type()))->WithRefArg)("outstr", outstr, tgr_ptr_type(tgr_char_type()))->WithRefArg)("__return", &__return, tgr_int_type())->End)(); 
return __return; 
}  
return __return; 
