# 1 "C:\\Users\\fujisawa\\AppData\\Local\\Temp\\ParaSoft.14332.7875\\ParaSoft.14332.20860.c"
...
struct __CPTR_Initializer_2942093191_14332_3990739431 {
    __CPTR_Initializer_2942093191_14332_3990739431()
    {
...
static struct __CPTR_Initializer_2942093191_14332_3990739431 __CPTR_initializer_2942093191_14332_3990739431;
#endif

#define CPPTEST_ENTER_MAIN_ROUTINE() __CPTR_Initializer_2942093191_14332_3990739431 __CPTR_main_initializer
...
# 36 "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\stubs\\calc_stub.c"
int calc(char * instr, int * result); 
#if defined(CPPTEST_USER_STUB_calc)
# 37
int CppTest_Stub_calc_calc(char *instr, int *result) 
{ 
...
(((((tgr_run("calc", c_tgr_run_before)->WithRefArg)("instr", &instr, tgr_ptr_type(tgr_char_type()))->WithRefArg)("result", result, tgr_ptr_type(tgr_int_type()))->WithRefArg)("__return", &__return, tgr_int_type())->WithRefArg)("__callOrig", &__callOrig, tgr_int_type())->End)(); 
if (__callOrig) { 
int __return = calc(instr, result); 
((((tgr_run("calc", c_tgr_run_after)->WithRefArg)("instr", &instr, tgr_ptr_type(tgr_char_type()))->WithRefArg)("result", result, tgr_ptr_type(tgr_int_type()))->WithRefArg)("__return", &__return, tgr_int_type())->End)(); 
return __return; 
}  
return __return; 
