# 1 "C:\\Users\\fujisawa\\AppData\\Local\\Temp\\ParaSoft.16444.14713\\ParaSoft.16444.4626.c"
...
CppTestTranslationUnitInfo __CPTR_tui_3645249126_16444_3990736663 = 
{
    0U, 
    "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\.cpptest\\calcurator\\file-data\\calculator.c7d783597\\tested\\harness_calculator.ildb"
};

#define __CPTR_tui &__CPTR_tui_3645249126_16444_3990736663
...
struct __CPTR_Initializer_3645249126_16444_3990736663 {
    __CPTR_Initializer_3645249126_16444_3990736663()
    {
...
static struct __CPTR_Initializer_3645249126_16444_3990736663 __CPTR_initializer_3645249126_16444_3990736663;
#endif

#define CPPTEST_ENTER_MAIN_ROUTINE() __CPTR_Initializer_3645249126_16444_3990736663 __CPTR_main_initializer
...
#define _coverage_func_data_offset 8

static unsigned char _coverage_code[_coverage_code_size];

EXTERN_C_LINKAGE CppTestCoverageInfo __CPTR_cui_3645249126_16444_3990736663 = 
{ 
    /*prev=*/0, 
...
#define __CPTR_cui &__CPTR_cui_3645249126_16444_3990736663
#define __CPTR_fid(ID) ID + __CPTR_cui_3645249126_16444_3990736663.funcIdOffset
...
const char* _cpptest_strdata[] = {
    ...
    "",
    "main",
    "TestSuite_main_551fb357",
    "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\tests\\autogenerated\\calculator\\src\\calculator.c\\TestSuite_main.c",
    0
};
#undef unix
#undef __unix
...
#if defined(CPPTEST_STUB_inputconsole) || CPPTEST_ENABLE_ALL_STUBS
# if defined(CPPTEST_SAFE_STUB_inputconsole)
#  define CppTest_Stub__Call_inputconsole_inputconsole CppTest_Safe_Stub_inputconsole_inputconsole
#  if defined(CPPTEST_UNDEFINED_inputconsole) 
#   define CppTest_Safe_Stub_inputconsole_inputconsole inputconsole
#  endif
# elif defined(CPPTEST_AUTO_STUB_inputconsole)
#  define CppTest_Stub__Call_inputconsole_inputconsole CppTest_Auto_Stub_inputconsole_inputconsole
#  if defined(CPPTEST_UNDEFINED_inputconsole) 
#   define CppTest_Auto_Stub_inputconsole_inputconsole inputconsole
#  endif
# else
#  define CppTest_Stub__Call_inputconsole_inputconsole CppTest_Stub_inputconsole_inputconsole
#  if defined(CPPTEST_UNDEFINED_inputconsole) 
#   define CppTest_Stub_inputconsole_inputconsole inputconsole
#  endif
#  define CPPTEST_USER_STUB_inputconsole
# endif
#else
# define CppTest_Stub__Call_inputconsole_inputconsole inputconsole
#endif

#if defined(CPPTEST_STUB_createOutputStatement) || CPPTEST_ENABLE_ALL_STUBS
# if defined(CPPTEST_SAFE_STUB_createOutputStatement)
#  define CppTest_Stub__Call_createOutputStatement_createOutputStatement CppTest_Safe_Stub_createOutputStatement_createOutputStatement
#  if defined(CPPTEST_UNDEFINED_createOutputStatement) 
#   define CppTest_Safe_Stub_createOutputStatement_createOutputStatement createOutputStatement
#  endif
# elif defined(CPPTEST_AUTO_STUB_createOutputStatement)
#  define CppTest_Stub__Call_createOutputStatement_createOutputStatement CppTest_Auto_Stub_createOutputStatement_createOutputStatement
#  if defined(CPPTEST_UNDEFINED_createOutputStatement) 
#   define CppTest_Auto_Stub_createOutputStatement_createOutputStatement createOutputStatement
#  endif
# else
#  define CppTest_Stub__Call_createOutputStatement_createOutputStatement CppTest_Stub_createOutputStatement_createOutputStatement
#  if defined(CPPTEST_UNDEFINED_createOutputStatement) 
#   define CppTest_Stub_createOutputStatement_createOutputStatement createOutputStatement
#  endif
#  define CPPTEST_USER_STUB_createOutputStatement
# endif
#else
# define CppTest_Stub__Call_createOutputStatement_createOutputStatement createOutputStatement
#endif
...
#if !defined(CppTest_Stub_inputconsole_inputconsole) && defined(CPPTEST_USER_STUB_inputconsole)
void CppTest_Stub_inputconsole_inputconsole(char *); 
#endif

#if !defined(CppTest_Safe_Stub_inputconsole_inputconsole) && defined(CPPTEST_SAFE_STUB_inputconsole)
void CppTest_Safe_Stub_inputconsole_inputconsole(char *); 
#endif

#if !defined(CppTest_Auto_Stub_inputconsole_inputconsole) && defined(CPPTEST_AUTO_STUB_inputconsole)
void CppTest_Auto_Stub_inputconsole_inputconsole(char *); 
#endif
# 13 "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\calculator\\src\\viewer.h"
...
#if !defined(CppTest_Stub_createOutputStatement_createOutputStatement) && defined(CPPTEST_USER_STUB_createOutputStatement)
void CppTest_Stub_createOutputStatement_createOutputStatement(char *, char *); 
#endif

#if !defined(CppTest_Safe_Stub_createOutputStatement_createOutputStatement) && defined(CPPTEST_SAFE_STUB_createOutputStatement)
void CppTest_Safe_Stub_createOutputStatement_createOutputStatement(char *, char *); 
#endif

#if !defined(CppTest_Auto_Stub_createOutputStatement_createOutputStatement) && defined(CPPTEST_AUTO_STUB_createOutputStatement)
void CppTest_Auto_Stub_createOutputStatement_createOutputStatement(char *, char *); 
#endif
# 17
void createOutputStatement(char *, char *); 
# 17 "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\calculator\\src\\calculator.c"
int newMain(void) { CPPTEST_STACK_TRACE_FUNC_START_INFO() const unsigned int _CppTest_funcId = cpptestCoverageFunction(__CPTR_cui, _cpptest_strdata[2], 1);int _coverage_decl_var_1 = cpptestCoverageStmt(1U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);
char str1[256]; int _coverage_decl_var_2 = cpptestCoverageStmt(2U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);
int result; int _coverage_decl_var_3 = cpptestCoverageStmt(3U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);
char str2[256]; cpptestCoverageStmt(4U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(1) 
CppTest_Stub__Call_inputconsole_inputconsole(str1); cpptestCoverageStmt(5U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(2) 
CppTest_Stub__Call_createOutputStatement_createOutputStatement(str1, str2); cpptestCoverageStmt(6U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(3) 


CppTest_Stub__Call_printf_printf("%s\n", str2); cpptestCoverageStmt(7U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
return 0; return 0;
} 
# 6 "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\tests\\autogenerated\\calculator\\src\\calculator.c\\TestSuite_main.c"
void TestSuite_main_551fb357_testSuiteBegin(void); 
int TestSuite_main_551fb357_callTest(const char *); 

static void (*TestSuite_main_551fb357_call_slave_ptr)(void); static void TestSuite_main_551fb357_call_slave(void) { CPPTEST_STACK_TRACE_FUNC_START_INFO() void TestSuite_main_551fb357_setUp(void); void TestSuite_main_551fb357_tearDown(void); CPPTEST_STACK_TRACE_STMT_INFO(4) cpptestIgnoreCurrStackElement(); CPPTEST_STACK_TRACE_STMT_INFO(5) TestSuite_main_551fb357_setUp(); CPPTEST_STACK_TRACE_STMT_INFO(6) TestSuite_main_551fb357_call_slave_ptr(); CPPTEST_STACK_TRACE_STMT_INFO(7) TestSuite_main_551fb357_tearDown(); CPPTEST_STACK_TRACE_EXIT_ROUTINE() } void TestSuite_main_551fb357_testSuiteBegin(void) { CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_STMT_INFO(8) cpptestTestSuiteBegin(_cpptest_strdata_var(3, "TestSuite_main_551fb357"), _cpptest_strdata_var(4, "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\tests\\autogenerated\\calculator\\src\\calcul" "ator.c\\TestSuite_main.c"), 9); CPPTEST_STACK_TRACE_EXIT_ROUTINE() } static int TestSuite_main_551fb357_callTestStatic(const char *name) { CPPTEST_STACK_TRACE_FUNC_START_INFO() static void (**call_slave_ptr_ptr)() = (&TestSuite_main_551fb357_call_slave_ptr); static void (*call_slave_ptr)() = (&TestSuite_main_551fb357_call_slave); CPPTEST_STACK_TRACE_STMT_INFO(9) cpptestIgnoreCurrStackElement(); CPPTEST_STACK_TRACE_STMT_INFO(10) ; CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
return 1; } 


int TestSuite_main_551fb357_callTest(const char *name) { CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_STMT_INFO(11) cpptestIgnoreCurrStackElement(); CPPTEST_STACK_TRACE_STMT_INFO(12) {int __T36783728 =  TestSuite_main_551fb357_callTestStatic(name);CPPTEST_STACK_TRACE_EXIT_ROUTINE() return __T36783728;}} 

void TestSuite_main_551fb357_setUp(void); 
void TestSuite_main_551fb357_setUp(void) 
{ CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
} 

void TestSuite_main_551fb357_tearDown(void); 
void TestSuite_main_551fb357_tearDown(void) 
{ CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
} 
