# 1 "C:\\Users\\fujisawa\\AppData\\Local\\Temp\\ParaSoft.16424.26175\\ParaSoft.16424.22434.c"
...
CppTestTranslationUnitInfo __CPTR_tui_3392828653_16424_3990735329 = 
{
    0U, 
    "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\.cpptest\\calcurator\\file-data\\calc.c7e29142a\\tested\\harness_calc.ildb"
};

#define __CPTR_tui &__CPTR_tui_3392828653_16424_3990735329
...
struct __CPTR_Initializer_3392828653_16424_3990735329 {
    __CPTR_Initializer_3392828653_16424_3990735329()
    {
...
static struct __CPTR_Initializer_3392828653_16424_3990735329 __CPTR_initializer_3392828653_16424_3990735329;
#endif

#define CPPTEST_ENTER_MAIN_ROUTINE() __CPTR_Initializer_3392828653_16424_3990735329 __CPTR_main_initializer
...
#define _coverage_code_size (1 + (57) / (sizeof(unsigned char) * 8))
#define _coverage_func_data_offset 56

static unsigned char _coverage_code[_coverage_code_size];

EXTERN_C_LINKAGE CppTestCoverageInfo __CPTR_cui_3392828653_16424_3990735329 = 
{ 
    /*prev=*/0, 
...
#define __CPTR_cui &__CPTR_cui_3392828653_16424_3990735329
#define __CPTR_fid(ID) ID + __CPTR_cui_3392828653_16424_3990735329.funcIdOffset
...
const char* _cpptest_strdata[] = {
    ...
    "",
    "calc",
    "TestSuite_calc_8c4be5c6",
    "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\tests\\autogenerated\\calculator\\src\\calc.c\\TestSuite_calc.c",
    "TestSuite_calc_8c4be5c6_test_calc",
    "CPPTEST_DS_GET_INTEGER(\"[OUT]calculaionResult\")",
    "_calculationResult",
...
int calc(char *, int *); 
# 9 "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\calculator\\src\\calc.c"
int calc(char *repolish, int *calculationResult) { CPPTEST_STACK_TRACE_FUNC_START_INFO() const unsigned int _CppTest_funcId = cpptestCoverageFunction(__CPTR_cui, _cpptest_strdata[2], 1);cpptestCoverageStmt(1U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(1) 
CppTest_Stub__Call_printf_printf("%s\n", repolish); int _coverage_decl_var_2 = cpptestCoverageStmt(2U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);
double stack[256]; int _coverage_decl_var_3 = cpptestCoverageStmt(3U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);
CPPTEST_STACK_TRACE_VARIABLE_INFO(anonymous__CPTR_0, 2) int stackindex = 0; int _coverage_decl_var_4 = cpptestCoverageStmt(4U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);
int cnt; int _coverage_decl_var_5 = cpptestCoverageStmt(5U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);
CPPTEST_STACK_TRACE_VARIABLE_INFO(anonymous__CPTR_1, 3) int tmp = 0; int _coverage_decl_var_6 = cpptestCoverageStmt(6U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);
double overflow_check; CPPTEST_STACK_TRACE_STMT_INFO(4) cpptestCoverageStmt(7U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);
for (cnt = 0; ((void)cpptestCoverageStmt(8U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1), *(repolish + cnt) != 0); ((void)cpptestCoverageStmt(9U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1), cnt++)) { CPPTEST_STACK_TRACE_STMT_INFO(5) 
switch (((void)cpptestCoverageStmt(10U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1), *(repolish + cnt))) { CPPTEST_STACK_TRACE_STMT_INFO(6) 
case 49:  CPPTEST_STACK_TRACE_STMT_INFO(7) 
case 50:  CPPTEST_STACK_TRACE_STMT_INFO(8) 
case 51:  CPPTEST_STACK_TRACE_STMT_INFO(9) 
case 52:  CPPTEST_STACK_TRACE_STMT_INFO(10) 
case 53:  CPPTEST_STACK_TRACE_STMT_INFO(11) 
case 54:  CPPTEST_STACK_TRACE_STMT_INFO(12) 
case 55:  CPPTEST_STACK_TRACE_STMT_INFO(13) 
case 56:  CPPTEST_STACK_TRACE_STMT_INFO(14) 
case 57:  CPPTEST_STACK_TRACE_STMT_INFO(15) 
case 48:  
if (((void)CPPTEST_STACK_TRACE_IF_COND_INFO(16) , ((void)cpptestCoverageStmt(11U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1), *((repolish + cnt) + 1) == 44))) { cpptestCoverageStmt(12U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(17) 
(stack)[stackindex] = tmp * 10 + (int)(*(repolish + cnt) - 48); 
if (((void)CPPTEST_STACK_TRACE_IF_COND_INFO(18) , ((void)cpptestCoverageStmt(13U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1), (stack)[stackindex] < 0))) { cpptestCoverageStmt(14U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(19) 
*calculationResult = 0; cpptestCoverageStmt(15U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
return 8; 
}  cpptestCoverageStmt(16U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(20) 
tmp = 0; cpptestCoverageStmt(17U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(21) 
stackindex++; cpptestCoverageStmt(18U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(22) 
cnt++; CPPTEST_STACK_TRACE_BLOCK_END_INFO(23) 
} else { cpptestCoverageStmt(19U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(24) 
tmp = tmp * 10 + (int)(*(repolish + cnt) - 48); cpptestCoverageStmt(20U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(25) ; CPPTEST_STACK_TRACE_BLOCK_END_INFO(26) 
}  cpptestCoverageStmt(21U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(27) 
break; CPPTEST_STACK_TRACE_STMT_INFO(28) 
case 43:  


if (((void)CPPTEST_STACK_TRACE_IF_COND_INFO(29) , ((void)cpptestCoverageStmt(22U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1), (stack)[stackindex - 2] + (stack)[stackindex - 1] > 2147483647))) { cpptestCoverageStmt(23U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(30) 
*calculationResult = 0; cpptestCoverageStmt(24U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
return 6; 
} else { cpptestCoverageStmt(25U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(31) 
(stack)[stackindex - 2] = (stack)[stackindex - 2] + (stack)[stackindex - 1]; cpptestCoverageStmt(26U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(32) 
stackindex--; CPPTEST_STACK_TRACE_BLOCK_END_INFO(33) 
}  cpptestCoverageStmt(27U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(34) 
break; CPPTEST_STACK_TRACE_STMT_INFO(35) 
case 45:  


if (((void)CPPTEST_STACK_TRACE_IF_COND_INFO(36) , ((void)cpptestCoverageStmt(28U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1), (stack)[stackindex - 2] - (stack)[stackindex - 1] < (-2147483647 - 1)))) { cpptestCoverageStmt(29U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(37) 
*calculationResult = 0; cpptestCoverageStmt(30U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
return 7; 
} else { cpptestCoverageStmt(31U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(38) 
(stack)[stackindex - 2] = (stack)[stackindex - 2] - (stack)[stackindex - 1]; cpptestCoverageStmt(32U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(39) 
stackindex--; CPPTEST_STACK_TRACE_BLOCK_END_INFO(40) 
}  cpptestCoverageStmt(33U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(41) 
break; CPPTEST_STACK_TRACE_STMT_INFO(42) 
case 42:  cpptestCoverageStmt(34U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(43) 
overflow_check = (stack)[stackindex - 2] * (stack)[stackindex - 1]; 

if (((void)CPPTEST_STACK_TRACE_IF_COND_INFO(44) , ((void)cpptestCoverageStmt(35U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1), overflow_check > 2147483647))) { cpptestCoverageStmt(36U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(45) 
*calculationResult = 0; cpptestCoverageStmt(37U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
return 6; 
} else { if (((void)CPPTEST_STACK_TRACE_IF_COND_INFO(46) , ((void)cpptestCoverageStmt(38U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1), overflow_check < (-2147483647 - 1)))) { cpptestCoverageStmt(39U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(47) 
*calculationResult = 0; cpptestCoverageStmt(40U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
return 7; 
} else { cpptestCoverageStmt(41U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(48) 
(stack)[stackindex - 2] = overflow_check; cpptestCoverageStmt(42U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(49) 
stackindex--; CPPTEST_STACK_TRACE_BLOCK_END_INFO(50) 
}  }  cpptestCoverageStmt(43U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(51) 
break; CPPTEST_STACK_TRACE_STMT_INFO(52) 
case 47:  
if (((void)CPPTEST_STACK_TRACE_IF_COND_INFO(53) , ((void)cpptestCoverageStmt(44U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1), (stack)[stackindex - 1] == 0))) { cpptestCoverageStmt(45U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(54) 
*calculationResult = 0; cpptestCoverageStmt(46U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
return 5; 
}  cpptestCoverageStmt(47U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(55) 
(stack)[stackindex - 2] = (stack)[stackindex - 2] / (stack)[stackindex - 1]; cpptestCoverageStmt(48U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(56) 
stackindex--; cpptestCoverageStmt(49U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(57) 
break; 
default:  cpptestCoverageStmt(50U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(58) 
break; 
}  CPPTEST_STACK_TRACE_BLOCK_END_INFO(59) 
}  
if (((void)CPPTEST_STACK_TRACE_IF_COND_INFO(60) , ((void)cpptestCoverageStmt(51U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1), (stack)[0] > 0))) { cpptestCoverageStmt(52U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(61) 
(stack)[0] = (stack)[0] + (0.5); CPPTEST_STACK_TRACE_BLOCK_END_INFO(62) 
} else { cpptestCoverageStmt(53U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(63) 
(stack)[0] = (stack)[0] - (0.5); CPPTEST_STACK_TRACE_BLOCK_END_INFO(64) 
}  cpptestCoverageStmt(54U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(65) 
*calculationResult = (int)((stack)[0]); cpptestCoverageStmt(55U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_EXIT_ROUTINE() 

return 0; 

} 
# 6 "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\tests\\autogenerated\\calculator\\src\\calc.c\\TestSuite_calc.c"
void TestSuite_calc_8c4be5c6_testSuiteBegin(void); 
int TestSuite_calc_8c4be5c6_callTest(const char *); 

static void (*TestSuite_calc_8c4be5c6_call_slave_ptr)(void); static void TestSuite_calc_8c4be5c6_call_slave(void) { CPPTEST_STACK_TRACE_FUNC_START_INFO() void TestSuite_calc_8c4be5c6_setUp(void); void TestSuite_calc_8c4be5c6_tearDown(void); CPPTEST_STACK_TRACE_STMT_INFO(66) cpptestIgnoreCurrStackElement(); CPPTEST_STACK_TRACE_STMT_INFO(67) TestSuite_calc_8c4be5c6_setUp(); CPPTEST_STACK_TRACE_STMT_INFO(68) TestSuite_calc_8c4be5c6_call_slave_ptr(); CPPTEST_STACK_TRACE_STMT_INFO(69) TestSuite_calc_8c4be5c6_tearDown(); CPPTEST_STACK_TRACE_EXIT_ROUTINE() } void TestSuite_calc_8c4be5c6_testSuiteBegin(void) { CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_STMT_INFO(70) cpptestTestSuiteBegin(_cpptest_strdata_var(3, "TestSuite_calc_8c4be5c6"), _cpptest_strdata_var(4, "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\tests\\autogenerated\\calculator\\src\\calc.c" "\\TestSuite_calc.c"), 9); CPPTEST_STACK_TRACE_EXIT_ROUTINE() } static int TestSuite_calc_8c4be5c6_callTestStatic(const char *name) { CPPTEST_STACK_TRACE_FUNC_START_INFO() static void (**call_slave_ptr_ptr)() = (&TestSuite_calc_8c4be5c6_call_slave_ptr); static void (*call_slave_ptr)() = (&TestSuite_calc_8c4be5c6_call_slave); CPPTEST_STACK_TRACE_STMT_INFO(71) cpptestIgnoreCurrStackElement(); CPPTEST_STACK_TRACE_STMT_INFO(72) ; 
if (((void)CPPTEST_STACK_TRACE_IF_COND_INFO(73) , cpptestStrCmp(name, "TestSuite_calc_8c4be5c6_test_calc") == 0)) { CPPTEST_STACK_TRACE_STMT_INFO(74) cpptestDsTestCaseBegin(_cpptest_strdata_var(5, "TestSuite_calc_8c4be5c6_test_calc"), 0U, 0xffffU, 0, _cpptest_strdata_var(4, "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\tests\\autogenerated\\calculator\\src\\calc.c" "\\TestSuite_calc.c"), 10); CPPTEST_STACK_TRACE_STMT_INFO(75) cpptestDsForCurrentTestCaseInitialized(CppTest_Ds("calctest")); CPPTEST_STACK_TRACE_STMT_INFO(76) while ((((cpptestGetCurrentDataSource() || cpptestDsNotInitialized()), (cpptestGetCurrentDataSource()->hasMoreData || cpptestDsMethodNotInitialized("hasMoreData"))), (cpptestGetCurrentDataSource()->hasMoreData))(cpptestGetCurrentDataSource())) { if (((void)CPPTEST_STACK_TRACE_IF_COND_INFO(77) , (((cpptestGetCurrentDataSource() || cpptestDsNotInitialized()), (cpptestGetCurrentDataSource()->loadNextData || cpptestDsMethodNotInitialized("loadNextData"))), (cpptestGetCurrentDataSource()->loadNextData))(cpptestGetCurrentDataSource()))) { CPPTEST_STACK_TRACE_STMT_INFO(78) cpptestDsTestCaseIterationBegin(CPPTEST_DS_GET_ITERATION(), 0); { void TestSuite_calc_8c4be5c6_test_calc(); CPPTEST_STACK_TRACE_STMT_INFO(79) (*call_slave_ptr_ptr) = &TestSuite_calc_8c4be5c6_test_calc; CPPTEST_STACK_TRACE_STMT_INFO(80) cpptestTestCaseSlave(call_slave_ptr); CPPTEST_STACK_TRACE_BLOCK_END_INFO(81) } CPPTEST_STACK_TRACE_STMT_INFO(82) cpptestDsTestCaseIterationEnd(); CPPTEST_STACK_TRACE_BLOCK_END_INFO(83) }  CPPTEST_STACK_TRACE_BLOCK_END_INFO(84) }  CPPTEST_STACK_TRACE_STMT_INFO(85) (((cpptestGetCurrentDataSource() || cpptestDsNotInitialized()), (cpptestGetCurrentDataSource()->finalize || cpptestDsMethodNotInitialized("finalize"))), (cpptestGetCurrentDataSource()->finalize))(cpptestGetCurrentDataSource()); CPPTEST_STACK_TRACE_STMT_INFO(86) cpptestDsTestCaseEnd(); CPPTEST_STACK_TRACE_EXIT_ROUTINE() return 0; }  CPPTEST_STACK_TRACE_STMT_INFO(87) ; CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
return 1; } 


void TestSuite_calc_8c4be5c6_test_calc(void); 
int TestSuite_calc_8c4be5c6_callTest(const char *name) { CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_STMT_INFO(88) cpptestIgnoreCurrStackElement(); CPPTEST_STACK_TRACE_STMT_INFO(89) {int __T36725400 =  TestSuite_calc_8c4be5c6_callTestStatic(name);CPPTEST_STACK_TRACE_EXIT_ROUTINE() return __T36725400;}} 
...
# 82 "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\tests\\autogenerated\\calculator\\src\\calc.c\\TestSuite_calc.c"
CPPTEST_STACK_TRACE_VARIABLE_INFO(anonymous__CPTR_2, 90) char *_repolish = (char *)CPPTEST_DS_GET_CSTR("[IN]repolish"); 
int _calculationResult; 
CPPTEST_STACK_TRACE_VARIABLE_INFO(anonymous__CPTR_3, 91) int _return = calc(_repolish, &_calculationResult); CPPTEST_STACK_TRACE_STMT_INFO(92) 
cpptestIntegerEqualAssertion(((CPPTEST_DS_GET_INTEGER("[OUT]calculaionResult")) == (_calculationResult)), (CPPTEST_DS_GET_INTEGER("[OUT]calculaionResult")), (_calculationResult), 0, 0, 0, 0, _cpptest_strdata_var(6, "CPPTEST_DS_GET_INTEGER(\"[OUT]calculaionResult\")"), _cpptest_strdata_var(7, "_calculationResult"), _cpptest_strdata_var(4, "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\tests\\autogenerated\\calculator\\src\\calc.c" "\\TestSuite_calc.c"), 85); CPPTEST_STACK_TRACE_STMT_INFO(93) ; CPPTEST_STACK_TRACE_STMT_INFO(94) 
cpptestIntegerEqualAssertion(((CPPTEST_DS_GET_INTEGER("[OUT]return")) == (_return)), (CPPTEST_DS_GET_INTEGER("[OUT]return")), (_return), 0, 0, 0, 0, _cpptest_strdata_var(8, "CPPTEST_DS_GET_INTEGER(\"[OUT]return\")"), _cpptest_strdata_var(9, "_return"), _cpptest_strdata_var(4, "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\tests\\autogenerated\\calculator\\src\\calc.c" "\\TestSuite_calc.c"), 86); CPPTEST_STACK_TRACE_STMT_INFO(95) ; CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
} 
