# 1 "C:\\Users\\fujisawa\\AppData\\Local\\Temp\\ParaSoft.16124.13328\\ParaSoft.16124.26621.c"
...
struct __CPTR_Initializer_3384365911_16124_3990741104 {
    __CPTR_Initializer_3384365911_16124_3990741104()
    {
...
static struct __CPTR_Initializer_3384365911_16124_3990741104 __CPTR_initializer_3384365911_16124_3990741104;
#endif

#define CPPTEST_ENTER_MAIN_ROUTINE() __CPTR_Initializer_3384365911_16124_3990741104 __CPTR_main_initializer
...
# 36 "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\stubs\\formatCheck_stub.c"
int formatCheck(char * instr); 
#if defined(CPPTEST_USER_STUB_formatCheck)
# 37
int CppTest_Stub_formatCheck_formatCheck(char *instr) 
{ 

int __return = 0; 
int __callOrig = 0; 

((((tgr_run("formatCheck", c_tgr_run_before)->WithRefArg)("instr", &instr, tgr_ptr_type(tgr_char_type()))->WithRefArg)("__return", &__return, tgr_int_type())->WithRefArg)("__callOrig", &__callOrig, tgr_int_type())->End)(); 
if (__callOrig) { 
int __return = formatCheck(instr); 
(((tgr_run("formatCheck", c_tgr_run_after)->WithRefArg)("instr", &instr, tgr_ptr_type(tgr_char_type()))->WithRefArg)("__return", &__return, tgr_int_type())->End)(); 
return __return; 
}  
return __return; 
