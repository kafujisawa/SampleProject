# 1 "C:\\Users\\fujisawa\\AppData\\Local\\Temp\\ParaSoft.16568.24758\\ParaSoft.16568.17781.c"
...
CppTestTranslationUnitInfo __CPTR_tui_2361223978_16568_3990736683 = 
{
    0U, 
    "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\.cpptest\\calcurator\\file-data\\viewer.cea5e08a7\\tested\\harness_viewer.ildb"
};

#define __CPTR_tui &__CPTR_tui_2361223978_16568_3990736683
...
struct __CPTR_Initializer_2361223978_16568_3990736683 {
    __CPTR_Initializer_2361223978_16568_3990736683()
    {
...
static struct __CPTR_Initializer_2361223978_16568_3990736683 __CPTR_initializer_2361223978_16568_3990736683;
#endif

#define CPPTEST_ENTER_MAIN_ROUTINE() __CPTR_Initializer_2361223978_16568_3990736683 __CPTR_main_initializer
...
#define _coverage_func_data_offset 7

static unsigned char _coverage_code[_coverage_code_size];

EXTERN_C_LINKAGE CppTestCoverageInfo __CPTR_cui_2361223978_16568_3990736683 = 
{ 
    /*prev=*/0, 
...
#define __CPTR_cui &__CPTR_cui_2361223978_16568_3990736683
#define __CPTR_fid(ID) ID + __CPTR_cui_2361223978_16568_3990736683.funcIdOffset
...
const char* _cpptest_strdata[] = {
    ...
    "inputconsole",
    "outputconsole",
    "TestSuite_inputconsole_71ca74f1",
    "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\tests\\autogenerated\\calculator\\src\\viewer.c\\TestSuite_inputconsole.c",
    "TestSuite_outputconsole_49898469",
    "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\tests\\autogenerated\\calculator\\src\\viewer.c\\TestSuite_outputconsole.c",
    0
};
#undef unix
#undef __unix
...
#if defined(CPPTEST_STUB_fgets) || CPPTEST_ENABLE_ALL_STUBS
...
# 10 "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\calculator\\src\\viewer.c"
void inputconsole(char *str2) { CPPTEST_STACK_TRACE_FUNC_START_INFO() const unsigned int _CppTest_funcId = cpptestCoverageFunction(__CPTR_cui, _cpptest_strdata[2], 1);cpptestCoverageStmt(1U, 1 + 0, __CPTR_cui, _CppTest_funcId, 1);CPPTEST_STACK_TRACE_STMT_INFO(1) 


CppTest_Stub__Call_fgets_fgets(str2, 256, ((CppTest_Stub__Call___getreent___getreent())->_stdin)); CPPTEST_STACK_TRACE_EXIT_ROUTINE() 


} 

void outputconsole(char str1[256]) { CPPTEST_STACK_TRACE_FUNC_START_INFO() const unsigned int _CppTest_funcId = cpptestCoverageFunction(__CPTR_cui, _cpptest_strdata[3], 2);int _coverage_decl_var_1 = cpptestCoverageStmt(1U, 2 + 0, __CPTR_cui, _CppTest_funcId, 2);
int i; CPPTEST_STACK_TRACE_STMT_INFO(2) cpptestCoverageStmt(2U, 2 + 0, __CPTR_cui, _CppTest_funcId, 2);
for (i = 0; ((void)cpptestCoverageStmt(3U, 2 + 0, __CPTR_cui, _CppTest_funcId, 2), str1[i] != 0); ((void)cpptestCoverageStmt(4U, 2 + 0, __CPTR_cui, _CppTest_funcId, 2), i++)) { cpptestCoverageStmt(5U, 2 + 0, __CPTR_cui, _CppTest_funcId, 2);CPPTEST_STACK_TRACE_STMT_INFO(3) 
CppTest_Stub__Call_printf_printf("%c ", str1[i]); }  CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
} 
# 6 "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\tests\\autogenerated\\calculator\\src\\viewer.c\\TestSuite_inputconsole.c"
void TestSuite_inputconsole_71ca74f1_testSuiteBegin(void); 
int TestSuite_inputconsole_71ca74f1_callTest(const char *); 

static void (*TestSuite_inputconsole_71ca74f1_call_slave_ptr)(void); static void TestSuite_inputconsole_71ca74f1_call_slave(void) { CPPTEST_STACK_TRACE_FUNC_START_INFO() void TestSuite_inputconsole_71ca74f1_setUp(void); void TestSuite_inputconsole_71ca74f1_tearDown(void); CPPTEST_STACK_TRACE_STMT_INFO(4) cpptestIgnoreCurrStackElement(); CPPTEST_STACK_TRACE_STMT_INFO(5) TestSuite_inputconsole_71ca74f1_setUp(); CPPTEST_STACK_TRACE_STMT_INFO(6) TestSuite_inputconsole_71ca74f1_call_slave_ptr(); CPPTEST_STACK_TRACE_STMT_INFO(7) TestSuite_inputconsole_71ca74f1_tearDown(); CPPTEST_STACK_TRACE_EXIT_ROUTINE() } void TestSuite_inputconsole_71ca74f1_testSuiteBegin(void) { CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_STMT_INFO(8) cpptestTestSuiteBegin(_cpptest_strdata_var(4, "TestSuite_inputconsole_71ca74f1"), _cpptest_strdata_var(5, "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\tests\\autogenerated\\calculator\\src\\viewer" ".c\\TestSuite_inputconsole.c"), 9); CPPTEST_STACK_TRACE_EXIT_ROUTINE() } static int TestSuite_inputconsole_71ca74f1_callTestStatic(const char *name) { CPPTEST_STACK_TRACE_FUNC_START_INFO() static void (**call_slave_ptr_ptr)() = (&TestSuite_inputconsole_71ca74f1_call_slave_ptr); static void (*call_slave_ptr)() = (&TestSuite_inputconsole_71ca74f1_call_slave); CPPTEST_STACK_TRACE_STMT_INFO(9) cpptestIgnoreCurrStackElement(); CPPTEST_STACK_TRACE_STMT_INFO(10) ; CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
return 1; } 


int TestSuite_inputconsole_71ca74f1_callTest(const char *name) { CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_STMT_INFO(11) cpptestIgnoreCurrStackElement(); CPPTEST_STACK_TRACE_STMT_INFO(12) {int __T35811824 =  TestSuite_inputconsole_71ca74f1_callTestStatic(name);CPPTEST_STACK_TRACE_EXIT_ROUTINE() return __T35811824;}} 

void TestSuite_inputconsole_71ca74f1_setUp(void); 
void TestSuite_inputconsole_71ca74f1_setUp(void) 
{ CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
} 

void TestSuite_inputconsole_71ca74f1_tearDown(void); 
void TestSuite_inputconsole_71ca74f1_tearDown(void) 
{ CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
} 
# 6 "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\tests\\autogenerated\\calculator\\src\\viewer.c\\TestSuite_outputconsole.c"
void TestSuite_outputconsole_49898469_testSuiteBegin(void); 
int TestSuite_outputconsole_49898469_callTest(const char *); 

static void (*TestSuite_outputconsole_49898469_call_slave_ptr)(void); static void TestSuite_outputconsole_49898469_call_slave(void) { CPPTEST_STACK_TRACE_FUNC_START_INFO() void TestSuite_outputconsole_49898469_setUp(void); void TestSuite_outputconsole_49898469_tearDown(void); CPPTEST_STACK_TRACE_STMT_INFO(13) cpptestIgnoreCurrStackElement(); CPPTEST_STACK_TRACE_STMT_INFO(14) TestSuite_outputconsole_49898469_setUp(); CPPTEST_STACK_TRACE_STMT_INFO(15) TestSuite_outputconsole_49898469_call_slave_ptr(); CPPTEST_STACK_TRACE_STMT_INFO(16) TestSuite_outputconsole_49898469_tearDown(); CPPTEST_STACK_TRACE_EXIT_ROUTINE() } void TestSuite_outputconsole_49898469_testSuiteBegin(void) { CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_STMT_INFO(17) cpptestTestSuiteBegin(_cpptest_strdata_var(6, "TestSuite_outputconsole_49898469"), _cpptest_strdata_var(7, "C:\\Program Files (x86)\\Jenkins\\workspace\\gitSample\\SampleProject\\calcurator\\tests\\autogenerated\\calculator\\src\\viewer" ".c\\TestSuite_outputconsole.c"), 9); CPPTEST_STACK_TRACE_EXIT_ROUTINE() } static int TestSuite_outputconsole_49898469_callTestStatic(const char *name) { CPPTEST_STACK_TRACE_FUNC_START_INFO() static void (**call_slave_ptr_ptr)() = (&TestSuite_outputconsole_49898469_call_slave_ptr); static void (*call_slave_ptr)() = (&TestSuite_outputconsole_49898469_call_slave); CPPTEST_STACK_TRACE_STMT_INFO(18) cpptestIgnoreCurrStackElement(); CPPTEST_STACK_TRACE_STMT_INFO(19) ; CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
return 1; } 


int TestSuite_outputconsole_49898469_callTest(const char *name) { CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_STMT_INFO(20) cpptestIgnoreCurrStackElement(); CPPTEST_STACK_TRACE_STMT_INFO(21) {int __T35862104 =  TestSuite_outputconsole_49898469_callTestStatic(name);CPPTEST_STACK_TRACE_EXIT_ROUTINE() return __T35862104;}} 

void TestSuite_outputconsole_49898469_setUp(void); 
void TestSuite_outputconsole_49898469_setUp(void) 
{ CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
} 

void TestSuite_outputconsole_49898469_tearDown(void); 
void TestSuite_outputconsole_49898469_tearDown(void) 
{ CPPTEST_STACK_TRACE_FUNC_START_INFO() CPPTEST_STACK_TRACE_EXIT_ROUTINE() 
} 
